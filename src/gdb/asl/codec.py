...
from gdb.asl.base import AslError, AslType, pascal_to_snake, snake_to_pascal
...
def get_current_types() -> dict[str, type[AslType]]:
    ...
    """
    from gdb.asl import types # noqa PLC0415
    registry = {}
...
def get_old_versions() -> dict[str, dict[str | None, type[AslType]]]:
    ...
    """
    from gdb.asl.types import old_versions # noqa PLC0415
